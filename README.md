...
The thirteen figures: monthly sales trend · confusion matrices (XGBoost, RF) · model
...
forecast error comparison · LSTM training loss · SHAP summary.
...
|---|---|---|---|
| RMSE | 34,128,514 | 43,509,553 | LSTM |
| MAE | 23,533,954 | 28,922,927 | LSTM |
| MAPE | 11.31% | 13.29% | LSTM |

LSTM beats the classical baseline by **21.6% lower RMSE**, on the same series and the
...
|---|---|---|---|
| RMSE | ৩,৪১,২৮,৫১৪ | ৪,৩৫,০৯,৫৫৩ | LSTM |
| MAE | ২,৩৫,৩৩,৯৫৪ | ২,৮৯,২২,৯২৭ | LSTM |
| MAPE | ১১.৩১% | ১৩.২৯% | LSTM |

LSTM প্রচলিত ARIMA-কে **২১.৬% কম RMSE** দিয়ে হারিয়েছে — একই সিরিজে, একই
