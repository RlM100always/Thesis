...
### 7.2 The leakage ablation — why 94.81% was not a result

The original pipeline reported 94.81%. Isolating each leak on the same split:

| Variant | XGBoost accuracy | McNemar XGB vs RF |
|---|---|---|
| Transaction-level + CLV (both leaks) | 94.81% | — |
...
|---|---|---|
| v1: লেনদেন-লেভেল + CLV (দুই লিকেজ) | ৯৪.৮১% | — |
